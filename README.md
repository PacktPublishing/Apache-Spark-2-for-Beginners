...
b. Build Spark from source or use the binary download and follow the detailed instructions given in the page<br> http://spark.apache.org/docs/latest/building-spark.html
